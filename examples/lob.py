...
np.testing.assert_almost_equal(lob.spread_tick, int(round(lob.spread / lob.tick_size, 0)))
...
np.testing.assert_almost_equal(
    lob.vw_midprice,
    (lob.bid * lob.bidq + lob.ask * lob.askq) / (lob.bidq + lob.askq),
)
...
np.testing.assert_almost_equal(
    lob.aggq("b", price=99.7), lob.bidq[0] + lob.bidq[1]  # should include first two bid levels
)
...
comp_book = LOB(tick_size=0.1, bids=[(99.7, 20), (99.2, 30)], asks=[(99.9, 15), (101.0, 25)])
